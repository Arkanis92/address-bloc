...
describe("ContactController", () => {
  ...
  describe("#addContact()", () => {
    it("should add a single contact into the book", (done) => {
      this.book.addContact("Alice", "001-101-1010", "alice.test@gmail.com")
      .then((contact) => {
  ...
  describe("search methods", () => {
    const zelda = ["Zelda Smith", "000-001-0001", "zelda@nintendo.com"];
    const snake = ["Solid Snake", "000-100-1000", "snake@konami.com"];
    const magus = ["Magus Johnson", "101-101-1010", "magus@squaresoft.com"];
        ...
        .then(() => {
          ...
          .then(() => {
            ...
            .then((contacts) => {
              ...
              expect(contact.phone).toBe("101-101-1010");
      ...
      it("should return the contact when found", (done) => {
        ...
        .then(() => {
          ...
          .then((contact) => {
            ...
            expect(contact.phone).toBe("000-100-1000");
